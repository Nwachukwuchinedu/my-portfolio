    ...
    <section className="py-24 px-6 max-w-7xl mx-auto" id="projects">
      ...
      <div className="flex flex-col gap-12 pb-24">
        {projects.map((project, index) => (
          <div
            key={index}
            className={`sticky ${project.bg} rounded-[48px] p-8 md:p-12 border border-white shadow-sm hover:shadow-xl transition-shadow duration-300 min-h-[500px] flex flex-col md:flex-row gap-8 items-center reveal-on-scroll`}
            style={{
              top: `calc(8rem + ${index * 2}rem)`, // Start at top-32 (8rem) and increment by 2rem for better visibility
              zIndex: 10 + index
            }}
          >
